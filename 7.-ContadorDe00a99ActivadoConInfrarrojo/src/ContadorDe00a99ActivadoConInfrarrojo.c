...
Comments: Práctica 7 Contador de 00 a 99 activado con infrarrojo
...
while (1)
      {
        ...
        PORTB = tabla7segmentos [var / 10] ^ 0xff;//con mascara para leds de anodo
        PORTA = tabla7segmentos [var % 10] ^ 0xff;//con mascara para leds de anodo
        botonp = botona;
      }
}
