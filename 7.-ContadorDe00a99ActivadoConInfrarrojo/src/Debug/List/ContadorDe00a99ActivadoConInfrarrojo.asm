...
; 0000 0089 TWCR=(0<<TWEA) | (0<<TWSTA) | (0<<TWSTO) | (0<<TWEN) | (0<<TWIE);
	OUT  0x36,R30
; 0000 008A 
; 0000 008B PORTB = tabla7segmentos [0];
	LDI  R30,LOW(_tabla7segmentos*2)
	LDI  R31,HIGH(_tabla7segmentos*2)
	LPM  R0,Z
	OUT  0x18,R0
; 0000 008C PORTA = PORTB;
	IN   R30,0x18
	OUT  0x1B,R30
; 0000 008D while (1)
_0x3:
; 0000 008E       {
; 0000 008F         botona = boton;
	CLT
	SBIC 0x10,0
	SET
	BLD  R2,1
; 0000 0090         if ((botonp == 1)&&(botona == 0)) //hubo cambio de flanco de 1 a 0
	SBRS R2,0
	RJMP _0x7
	SBRS R2,1
	RJMP _0x8
...
_0x9:
	...
	RCALL _delay_ms
; 0000 0096         }
; 0000 0097         if ((botonp == 0)&&(botona == 1)) //hubo cambio de flanco de 0 a 1
_0x6:
	SBRC R2,0
	RJMP _0xB
	SBRC R2,1
...
; 0000 0098             delay_ms(40); //Se coloca retardo de 40mS para eliminar rebotes
	...
	RCALL _delay_ms
; 0000 0099 
; 0000 009A         PORTB = tabla7segmentos [var / 10] ^ 0xff;//con mascara para leds de anodo
_0xA:
	MOV  R26,R5
	LDI  R27,0
	LDI  R30,LOW(10)
	...
	RCALL SUBOPT_0x0
	OUT  0x18,R30
; 0000 009B         PORTA = tabla7segmentos [var % 10] ^ 0xff;//con mascara para leds de anodo
	MOV  R26,R5
	CLR  R27
	LDI  R30,LOW(10)
	LDI  R31,HIGH(10)
