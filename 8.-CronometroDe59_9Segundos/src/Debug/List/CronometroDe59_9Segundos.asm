...
;
;#define push0 PIND.1
;char anterior = 0xff, opcion = 0xff;
;unsigned short var;
;const char tabla7SegmentosAnodo [10]={0xc0 ,0xf9 ,0xa4 ,0xb0 ,0x99 ,0x92 ,0x83 ,0xf8 ,0x80 ,0x90};   //Para Display de C ...
;
;void main(void)
; 0000 0021 {
...
; 0000 0027 DDRA=(1<<DDA7) | (1<<DDA6) | (1<<DDA5) | (1<<DDA4) | (1<<DDA3) | (1<<DDA2) | (1<<DDA1) | (1<<DDA0);
	LDI  R30,LOW(255)
	OUT  0x1A,R30
; 0000 0028 // State: Bit7=0 Bit6=1 Bit5=0 Bit4=0 Bit3=0 Bit2=0 Bit1=0 Bit0=0
; 0000 0029 PORTA=(0<<PORTA7) | (1<<PORTA6) | (0<<PORTA5) | (0<<PORTA4) | (0<<PORTA3) | (0<<PORTA2) | (0<<PORTA1) | (0<<PORTA0);
	LDI  R30,LOW(64)
	OUT  0x1B,R30
; 0000 002A 
...
; 0000 002D DDRB=(1<<DDB7) | (1<<DDB6) | (1<<DDB5) | (1<<DDB4) | (1<<DDB3) | (1<<DDB2) | (1<<DDB1) | (1<<DDB0);
	LDI  R30,LOW(255)
	OUT  0x17,R30
; 0000 002E // State: Bit7=0 Bit6=1 Bit5=0 Bit4=0 Bit3=0 Bit2=0 Bit1=0 Bit0=0
; 0000 002F PORTB=(0<<PORTB7) | (1<<PORTB6) | (0<<PORTB5) | (0<<PORTB4) | (0<<PORTB3) | (0<<PORTB2) | (0<<PORTB1) | (0<<PORTB0);
	LDI  R30,LOW(64)
	OUT  0x18,R30
; 0000 0030 
...
; 0000 0033 DDRC=(1<<DDC7) | (1<<DDC6) | (1<<DDC5) | (1<<DDC4) | (1<<DDC3) | (1<<DDC2) | (1<<DDC1) | (1<<DDC0);
	LDI  R30,LOW(255)
	OUT  0x14,R30
; 0000 0034 // State: Bit7=0 Bit6=1 Bit5=0 Bit4=0 Bit3=0 Bit2=0 Bit1=0 Bit0=0
; 0000 0035 PORTC=(0<<PORTC7) | (1<<PORTC6) | (0<<PORTC5) | (0<<PORTC4) | (0<<PORTC3) | (0<<PORTC2) | (0<<PORTC1) | (0<<PORTC0);
	LDI  R30,LOW(64)
	OUT  0x15,R30
; 0000 0036 
...
_0x3:
; 0000 008C       {
; 0000 008D         opcion = 0xff;
	LDI  R30,LOW(255)
	MOV  R4,R30
; 0000 008E         opcion &=  PIND;
	IN   R30,0x10
	AND  R4,R30
; 0000 008F         if(opcion == 0xff)
	LDI  R30,LOW(255)
	CP   R30,R4
	BRNE _0x6
; 0000 0090             opcion = anterior;
	MOV  R4,R5
; 0000 0091 
; 0000 0092         if(opcion != anterior)
_0x6:
	CP   R5,R4
	BREQ _0x7
; 0000 0093         {
; 0000 0094             if(opcion == 0xfe)//Reset
	LDI  R30,LOW(254)
	CP   R30,R4
	BRNE _0x8
; 0000 0095             {
; 0000 0096                 var = 0;
	CLR  R6
	CLR  R7
; 0000 0097                 PORTA = tabla7SegmentosAnodo[0];
	RCALL SUBOPT_0x0
	OUT  0x1B,R0
; 0000 0098                 PORTB = tabla7SegmentosAnodo[0];
	RCALL SUBOPT_0x0
	OUT  0x18,R0
; 0000 0099                 PORTC = tabla7SegmentosAnodo[0];
	RCALL SUBOPT_0x0
	OUT  0x15,R0
; 0000 009A             }
; 0000 009B 
; 0000 009C             anterior = opcion;
_0x8:
	MOV  R5,R4
...
; 0000 009E         }
; 0000 009F 
; 0000 00A0         if( opcion == 0xfb && opcion == anterior ) //start
_0x7:
	LDI  R30,LOW(251)
	CP   R30,R4
	BRNE _0xA
...
; 0000 00A2             if(600 - var)
	...
	BREQ _0xC
; 0000 00A3             {
; 0000 00A4                 PORTB = tabla7SegmentosAnodo[var / 100];
	RCALL SUBOPT_0x1
	RCALL SUBOPT_0x2
	OUT  0x18,R0
; 0000 00A5                 PORTA = tabla7SegmentosAnodo[var % 100 / 10];
	RCALL SUBOPT_0x1
	RCALL SUBOPT_0x3
	RCALL SUBOPT_0x2
	OUT  0x1B,R0
; 0000 00A6                 PORTC = tabla7SegmentosAnodo[var % 100 % 10];
	RCALL SUBOPT_0x1
	RCALL SUBOPT_0x3
	RCALL __MODW21U
...
; 0000 00AD             delay_ms(100);
	...
	RCALL _delay_ms
; 0000 00AE         }
; 0000 00AF         //si no entra a ninguna es stop
; 0000 00B0       }
_0x9:
	RJMP _0x3
; 0000 00B1 }
...
SUBOPT_0x0:
	LDI  R30,LOW(_tabla7SegmentosAnodo*2)
	LDI  R31,HIGH(_tabla7SegmentosAnodo*2)
	LPM  R0,Z
	RET
