...
_tabla7SegmentosAnodo:
	.DB  0xC0,0xF9,0xA4,0xB0,0x99,0x92,0x83,0xF8
...
;const char tabla7SegmentosAnodo [16]={0xc0 ,0xf9 ,0xa4 ,0xb0 ,0x99 ,0x92 ,0x83 ,0xf8 ,0x80 ,0x90, 0x88, 0x83, 0xc6, 0xa1 ...
;
...
; 0000 0030 DDRC=(0<<DDC7) | (0<<DDC6) | (0<<DDC5) | (0<<DDC4) | (1<<DDC3) | (1<<DDC2) | (1<<DDC1) | (1<<DDC0);
	LDI  R30,LOW(15)
	OUT  0x14,R30
; 0000 0031 // State: Bit7=P Bit6=P Bit5=P Bit4=P Bit3=0 Bit2=0 Bit1=0 Bit0=0
; 0000 0032 PORTC=(1<<PORTC7) | (1<<PORTC6) | (1<<PORTC5) | (1<<PORTC4) | (0<<PORTC3) | (0<<PORTC2) | (0<<PORTC1) | (0<<PORTC0);
	LDI  R30,LOW(240)
	OUT  0x15,R30
; 0000 0033 
...
_0x3:
; 0000 0089       {
; 0000 008A         //C0 A C3 son de salida y son para
; 0000 008B         //Probar las 4 columnas
; 0000 008C         //Se prueba la primera columna se envía 1110
; 0000 008D         PORTC=0b11111110;
	LDI  R30,LOW(254)
	RCALL SUBOPT_0x0
; 0000 008E         // C4 , C5 , C6 y C7 son las entradas del teclado
; 0000 008F         //Por eso se enmascaran con 11110000
; 0000 0090         lectura=PINC&0b11110000;
; 0000 0091         if (lectura==0b11100000)
	BRNE _0x6
; 0000 0092             tecla=0xc;
	LDI  R30,LOW(12)
	RJMP _0x23
; 0000 0093         else if (lectura==0b11010000)
_0x6:
	RCALL SUBOPT_0x1
	BRNE _0x8
; 0000 0094             tecla=0xd;
	LDI  R30,LOW(13)
	RJMP _0x23
; 0000 0095         else if (lectura==0b10110000)
_0x8:
	RCALL SUBOPT_0x2
	BRNE _0xA
; 0000 0096             tecla=0xe;
	LDI  R30,LOW(14)
	RJMP _0x23
; 0000 0097         else if (lectura==0b01110000)
_0xA:
	RCALL SUBOPT_0x3
	BRNE _0xC
; 0000 0098             tecla=0xf;
...
_0x23:
	MOV  R5,R30
; 0000 0099         //se prueba segunda columna se envía 1101
; 0000 009A         PORTC=0b11111101;
_0xC:
	LDI  R30,LOW(253)
	RCALL SUBOPT_0x0
; 0000 009B         //C4 , C5 , C6 y C7 son las entradas del teclado
; 0000 009C         //Por eso se enmascaran con 11110000
; 0000 009D         lectura=PINC&0b11110000;
; 0000 009E         if (lectura==0b11100000)
	BRNE _0xD
; 0000 009F             tecla=8;
	LDI  R30,LOW(8)
	RJMP _0x24
; 0000 00A0         else if (lectura==0b11010000)
_0xD:
	RCALL SUBOPT_0x1
	BRNE _0xF
; 0000 00A1             tecla=9;
	LDI  R30,LOW(9)
	RJMP _0x24
; 0000 00A2         else if (lectura==0b10110000)
_0xF:
	RCALL SUBOPT_0x2
	BRNE _0x11
; 0000 00A3             tecla=0xa;
	LDI  R30,LOW(10)
	RJMP _0x24
; 0000 00A4         else if (lectura==0b01110000)
_0x11:
	RCALL SUBOPT_0x3
	BRNE _0x13
; 0000 00A5             tecla=0xb;
...
_0x24:
	MOV  R5,R30
; 0000 00A6         //se prueba tercera columna se envía 1011
; 0000 00A7         PORTC=0b11111011;
_0x13:
	LDI  R30,LOW(251)
	RCALL SUBOPT_0x0
; 0000 00A8         //C4 , C5 , C6 y C7 son las entradas del teclado
; 0000 00A9         //Por eso se enmascaran con 11110000
; 0000 00AA         lectura=PINC&0b11110000;
; 0000 00AB         if (lectura==0b11100000)
	BRNE _0x14
; 0000 00AC             tecla=4;
	LDI  R30,LOW(4)
	RJMP _0x25
; 0000 00AD         else if (lectura==0b11010000)
_0x14:
	RCALL SUBOPT_0x1
	BRNE _0x16
; 0000 00AE             tecla=5;
	LDI  R30,LOW(5)
	RJMP _0x25
; 0000 00AF         else if (lectura==0b10110000)
_0x16:
	RCALL SUBOPT_0x2
	BRNE _0x18
; 0000 00B0             tecla=6;
	LDI  R30,LOW(6)
	RJMP _0x25
; 0000 00B1         else if (lectura==0b01110000)
_0x18:
	RCALL SUBOPT_0x3
	BRNE _0x1A
; 0000 00B2             tecla=7;
...
_0x25:
	MOV  R5,R30
; 0000 00B3          //se prueba tercera columna se envía 0111
; 0000 00B4         PORTC=0b11110111;
_0x1A:
	LDI  R30,LOW(247)
	RCALL SUBOPT_0x0
; 0000 00B5         //C4 , C5 , C6 y C7 son las entradas del teclado
; 0000 00B6         //Por eso se enmascaran con 11110000
; 0000 00B7         lectura=PINC&0b11110000;
; 0000 00B8         if (lectura==0b11100000)
	BRNE _0x1B
; 0000 00B9             tecla=0;
	CLR  R5
; 0000 00BA         else if (lectura==0b11010000)
	RJMP _0x1C
_0x1B:
	RCALL SUBOPT_0x1
	BRNE _0x1D
; 0000 00BB             tecla=1;
	LDI  R30,LOW(1)
	RJMP _0x26
; 0000 00BC         else if (lectura==0b10110000)
_0x1D:
	RCALL SUBOPT_0x2
	BRNE _0x1F
; 0000 00BD             tecla=2;
	LDI  R30,LOW(2)
	RJMP _0x26
; 0000 00BE         else if (lectura==0b01110000)
_0x1F:
	RCALL SUBOPT_0x3
	BRNE _0x21
; 0000 00BF             tecla=3;
...
_0x26:
	MOV  R5,R30
; 0000 00C0         PORTD=tabla7SegmentosAnodo[tecla];
_0x21:
_0x1C:
	MOV  R30,R5
	LDI  R31,0
	SUBI R30,LOW(-_tabla7SegmentosAnodo*2)
	SBCI R31,HIGH(-_tabla7SegmentosAnodo*2)
	LPM  R0,Z
	OUT  0x12,R0
; 0000 00C1 
; 0000 00C2       };
