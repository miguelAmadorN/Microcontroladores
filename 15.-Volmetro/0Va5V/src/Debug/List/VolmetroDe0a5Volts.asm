...
;#define dp PORTB.7
;unsigned char adc, calculo;
;char Unidades, Decimas;
...
_0x6:
; 0000 00A3       {
; 0000 00A4         adc = read_adc(0);
	LDI  R26,LOW(0)
	RCALL _read_adc
	MOV  R5,R30
; 0000 00A5         calculo = adc * 50 / 255;
	MOV  R26,R5
	LDI  R30,LOW(50)
	MUL  R30,R26
	MOVW R30,R0
...
; 0000 00A7         Decimas = calculo % 10;
	...
	MOV  R6,R30
; 0000 00A8 
; 0000 00A9         PORTB = tabla7SegmentosAnodo[Unidades];
	MOV  R30,R7
	RCALL SUBOPT_0x0
; 0000 00AA         dp = 0;
	CBI  0x18,7
; 0000 00AB         unidades = 1;
	SBI  0x15,1
; 0000 00AC         decimas = 0;
	CBI  0x15,0
; 0000 00AD         delay_ms(5);
	...
	LDI  R27,0
	RCALL _delay_ms
; 0000 00AE         PORTB = tabla7SegmentosAnodo[Decimas];
	MOV  R30,R6
	RCALL SUBOPT_0x0
; 0000 00AF         dp = 1;
	SBI  0x18,7
; 0000 00B0         unidades = 0;
	CBI  0x15,1
; 0000 00B1         decimas = 1;
	SBI  0x15,0
