...
;#include <delay.h>
;
;#define RESOLUCION 31 //31.875 para corregir si no da los 5V de referencia
;#define ITERACIONES 8
;unsigned char leds[9] = {0, 1, 3, 7, 15, 31, 63, 127, 255};

	.DSEG
;unsigned char i,  led1, led2, delay;
...
_0x7:
; 0000 00A2       {
; 0000 00A3         led1 = read_adc(0) / RESOLUCION;
	LDI  R26,LOW(0)
	RCALL SUBOPT_0x0
	MOV  R4,R30
; 0000 00A4         led2 = read_adc(1) / RESOLUCION;
	LDI  R26,LOW(1)
	RCALL SUBOPT_0x0
	MOV  R7,R30
; 0000 00A5         for(i = 0; i <= ITERACIONES; i++)
	CLR  R5
_0xB:
	LDI  R30,LOW(8)
	CP   R30,R5
