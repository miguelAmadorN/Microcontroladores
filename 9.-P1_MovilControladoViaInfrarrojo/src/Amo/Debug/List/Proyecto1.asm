...
_0x3:
; 0000 008A       {
; 0000 008B           opcion = PINB & 0x0f;
	IN   R30,0x16
	ANDI R30,LOW(0xF)
	MOV  R5,R30
; 0000 008C 
; 0000 008D           if(opcion == 0x0e)//Arribe
	LDI  R30,LOW(14)
	CP   R30,R5
	BRNE _0x6
; 0000 008E           {
; 0000 008F             for(var = 0; var < 20; var++)
	CLR  R4
_0x8:
	LDI  R30,LOW(20)
	CP   R4,R30
...
_0x9:
; 0000 0096           }
; 0000 0097           else if(opcion == 0x0d)//Abajo
	RJMP _0xA
_0x6:
	LDI  R30,LOW(13)
	CP   R30,R5
	BRNE _0xB
; 0000 0098           {
; 0000 0099             for(var = 0; var < 30 ; var++)
	CLR  R4
_0xD:
	LDI  R30,LOW(30)
	CP   R4,R30
...
_0xE:
; 0000 00A0           }
; 0000 00A1           else if(opcion == 0x0b)//Izquierda
	RJMP _0xF
_0xB:
	LDI  R30,LOW(11)
	CP   R30,R5
	BRNE _0x10
; 0000 00A2           {
; 0000 00A3             for(var = 0; var < 40; var++)
	CLR  R4
_0x12:
	LDI  R30,LOW(40)
	CP   R4,R30
...
_0x13:
; 0000 00AA           }
; 0000 00AB           else if(opcion == 0x07)//Derecha
	RJMP _0x14
_0x10:
	LDI  R30,LOW(7)
	CP   R30,R5
	BRNE _0x15
; 0000 00AC           {
; 0000 00AD             for(var = 0; var < 50; var++)
	CLR  R4
_0x17:
	LDI  R30,LOW(50)
	CP   R4,R30
