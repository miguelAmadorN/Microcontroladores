...
; 0000 001F     {
; 0000 0020 
; 0000 0021         delay_ms(6);
	LDI  R26,LOW(6)
	RCALL SUBOPT_0x0
; 0000 0022         if(PINB & 0x1)
	SBIS 0x16,0
	RJMP _0x6
; 0000 0023             delay_ms(4);
	LDI  R26,LOW(4)
	RCALL SUBOPT_0x0
; 0000 0024         else
	RJMP _0x7
_0x6:
; 0000 0025             return 0x2;     //izquierda
	LDI  R30,LOW(2)
	RET
; 0000 0026 
; 0000 0027         if(PINB & 0x1)
_0x7:
	SBIS 0x16,0
	RJMP _0x8
...
; 0000 0029         else
	RJMP _0x9
_0x8:
; 0000 002A             return 0x1;    //derecha
	LDI  R30,LOW(1)
	RET
; 0000 002B 
; 0000 002C         if(PINB & 0x1)
_0x9:
	SBIS 0x16,0
	RJMP _0xA
...
; 0000 002E         else
	RJMP _0xB
_0xA:
; 0000 002F             return 0x3;         //arribe
	LDI  R30,LOW(3)
	RET
; 0000 0030 
; 0000 0031         if(PINB & 0x1)
_0xB:
	SBIC 0x16,0
; 0000 0032             return 0;
	RJMP _0x2000001
; 0000 0033         else
; 0000 0034             return 0xc;         //abajo
	LDI  R30,LOW(12)
	RET
; 0000 0035     }
; 0000 0036     return 0;
...
; 0000 0046 DDRB=(0<<DDB7) | (0<<DDB6) | (0<<DDB5) | (0<<DDB4) | (0<<DDB3) | (0<<DDB2) | (0<<DDB1) | (0<<DDB0);
	OUT  0x17,R30
; 0000 0047 // State: Bit7=P Bit6=P Bit5=P Bit4=P Bit3=P Bit2=P Bit1=P Bit0=P
; 0000 0048 PORTB=(1<<PORTB7) | (1<<PORTB6) | (1<<PORTB5) | (1<<PORTB4) | (1<<PORTB3) | (1<<PORTB2) | (1<<PORTB1) | (1<<PORTB0);
	LDI  R30,LOW(255)
	OUT  0x18,R30
; 0000 0049 
...
_0xE:
; 0000 00A4       {
; 0000 00A5         anterior = PINB & 1;
	IN   R30,0x16
	ANDI R30,LOW(0x1)
	MOV  R5,R30
; 0000 00A6         PORTD = getPIN();
	RCALL _getPIN
	OUT  0x12,R30
; 0000 00A7         if(PORTD != 0)
	IN   R30,0x12
	CPI  R30,0
	BREQ _0x11
