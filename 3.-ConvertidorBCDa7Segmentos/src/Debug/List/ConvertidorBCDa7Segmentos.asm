...
_0x3:
; 0000 0088       {
; 0000 0089         variable = PIND & 0x0f; //Enmascaramos los 4 bits menos significativos
	IN   R30,0x10
	RCALL SUBOPT_0x0
; 0000 008A         //del puerto A ya que los demás no interesan.
; 0000 008B         if (variable < 10)
	BRSH _0x6
; 0000 008C             PORTB = tabla7segmentos[variable];
	RCALL SUBOPT_0x1
	LPM  R0,Z
	OUT  0x18,R0
; 0000 008D         else //Si lo que leemos es mayor o igual de 10 que dibuje en el display una E de ERROR
	RJMP _0x7
_0x6:
; 0000 008E             PORTB = 0x79;
	LDI  R30,LOW(121)
	OUT  0x18,R30
; 0000 008F 
; 0000 0090         variable = PINC & 0x0f;
_0x7:
	IN   R30,0x13
	RCALL SUBOPT_0x0
; 0000 0091         if(variable < 10)
	BRSH _0x8
; 0000 0092             PORTA = tabla7segmentos[variable] ^ 0xff;
	RCALL SUBOPT_0x1
	LPM  R26,Z
	LDI  R30,LOW(255)
	EOR  R30,R26
